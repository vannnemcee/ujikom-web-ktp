    ...
    <body>
        ...
        <main class="container">
            ...
            $tampil = "SELECT * FROM penduduk WHERE nik = '$nik'";
            ...
            <form method="post" action="">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="id_kelurahan" required>
                                ...
                                <?php
                                $q_kel = mysqli_query($koneksi, "SELECT * FROM kelurahan");
                                while ($kel = mysqli_fetch_assoc($q_kel)) {
                                    $selected = ($kel['id_kelurahan'] == $penduduk['id_kelurahan']) ? "selected" : "";
                    ...
                    <tr>
                        <td>Pekerjaan</td>
                        <td>
                            <select name="id_pekerjaan" required>
                                <option value="">-- Pilih Pekerjaan --</option>
                                <?php
                                $q_pek = mysqli_query($koneksi, "SELECT * FROM pekerjaan");
                                while ($pek = mysqli_fetch_assoc($q_pek)) {
                                    $selected = ($pek['id_pekerjaan'] == $penduduk['id_pekerjaan']) ? "selected" : "";
                                    echo "<option value='".$pek['id_pekerjaan']."' $selected>".$pek['nama_pekerjaan']."</option>";
                                }
                                ?>
                            </select>
                        </td>
